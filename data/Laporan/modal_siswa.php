...
<div id="cetaksiswa" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="data/Laporan/laporan_siswa.php" method="post" target="_blank">
				<table>
			...
			<div class="modal-footer">
				<a href="data/Laporan/laporan_siswa.php" target="_blank" class="btn btn-primary btn-sm">Cetak Semua Data</a>
			</div>
			</form>
		</div>
	</div>
