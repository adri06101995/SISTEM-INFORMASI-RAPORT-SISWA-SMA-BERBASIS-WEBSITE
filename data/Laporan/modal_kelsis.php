...
<div id="cetakkelsis" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title"> Cetak Data Kelas Siswa</h4>
			</div>
			<div class="modal-body">
				<form action="data/Laporan/laporan_kelsis.php" method="post" target="_blank">
				<table>
			...
			<div class="modal-footer">
				<a href="data/Laporan/laporan_kelsis.php" target="_blank" class="btn btn-primary btn-sm">Cetak Semua Data</a>
			</div>
			</form>
		</div>
	</div>
