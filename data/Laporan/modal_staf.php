	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"> Cetak Data Staf</h4>
			</div>
			<div class="modal-body">
				<form action="data/Laporan/laporan_staf.php" method="post" target="_blank">
				<table>
			...
			<div class="modal-footer">
				<a href="data/Laporan/laporan_staf.php" target="_blank" class="btn btn-primary btn-sm">Cetak Semua Data</a>
			</div>
			</form>
		</div>
	</div>
